...
SAVE_DATA_PATH = "C:\\Downloads\\rf_dump\\adc_data.bin"
...
ar1.ProfileConfig(0, 77, 100, 6, 120, 0, 0, 0, 0, 0, 0, 30.012, 0, 128, 2500, 0, 0, 30)
...
ar1.FrameConfig(0, 2, 0, 1, 1000, 0, 0, 1)
-------------------------------------
